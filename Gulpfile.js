var applicationName = 'moment';
var publicName = 'moment';
...
var templateFiles = [srcBaseDir + 'app/**/*.html', srcBaseDir + '/bower_components/oauth-ng/dist/views/**/*.html'];
...
var vendorFiles = [
  ...
  'src/bower_components/ngFitText/src/ng-FitText.js'
];
...
gulp.task('copy:fonts', function () {
    return gulp.src([srcBaseDir + 'bower_components/font-awesome/fonts/**/*.*', srcBaseDir + 'bower_components/ionicons/fonts/**/*.*', srcBaseDir + 'fonts/**/*.*'])
